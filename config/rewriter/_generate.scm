...
(define graphs
  '(<http://yourdatastories.eu/taxonomies/eurovoc> <http://yourdatastories.eu/ontology> <http://yourdatastories.eu/taxonomies> <http://yourdatastories.eu/catalog> <http://yourdatastories.eu/countries> <http://yourdatastories.eu/WorldFactbook> <http://yourdatastories.eu/WDI> <http://yourdatastories.eu/OpenCorporates> <http://yourdatastories.eu/regions> <http://yourdatastories.eu/HDI> <http://yourdatastories.eu/ODA/NL>  <http://yourdatastories.eu/ODA/ZW>  <http://yourdatastories.eu/trade/NL> <http://yourdatastories.eu/trade/ZW> <http://yourdatastories.eu/tradeagents> <http://yourdatastories.eu/tradeagents> <http://yourdatastories.eu/TEDUpdate>  <http://yourdatastories.eu/galwayTraffic> ))
...
(define-rest-call 'POST '("constraint")
  (lambda (_)
    (let ((q (generate-constraint)))
      ...
      (format (current-error-port) "~%==Regenerated Constraint==~%~%~A~%" (write-sparql q))
      '((success . "true")))))
